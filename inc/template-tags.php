...
function shoreditch_entry_footer() {
	if ( 'post' === get_post_type() ) {
		$time_string = '<time class="entry-date published updated date-publish rer-font-opensans" datetime="%1$s">Publicado el %2$s</time>';
		if ( get_the_time( 'U' ) !== get_the_modified_time( 'U' ) ) {
			$time_string = '<time class="entry-date published date-publish" datetime="%1$s">Publicado el %2$s</time><time class="updated" datetime="%3$s">%4$s</time>';
		}
