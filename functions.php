...
function shoreditch_widgets_init() {
	register_sidebar( array(
		...
		'before_title'  => '<h2 class="widget-title rer-font-roboto-bold">',
		'after_title'   => '</h2>',
	) );
...
function wpdocs_excerpt_more( $more ) {
    return sprintf( '...<a class="read-more" href="%1$s"><button class="read-more-button rer-font-opensans">%2$s</button></a>',
